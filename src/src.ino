...
void setup() {
	...
	if(isNFC_PASS){  buzzer1.siren();
		servo_move(window_r,0);
		servo_move(window_l,90);
...
void loop() {
	...
	lcd.setCursor(0, 0);
	lcd.print("Humid:" + String(th1.humidity()));
	lcd.setCursor(0, 1);
	lcd.print("Temp:" + String(th1.temperature()));




	if(gs1.isPolluted()){digitalWrite(34,HIGH);
	...
	if(! lt.isDark ()){ digitalWrite(35,HIGH);
		digitalWrite(33,HIGH);
